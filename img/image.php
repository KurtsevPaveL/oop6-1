<?php
    ...
    $sourceSerializedValues = '../temp/data-serialized-values.txt';
    $file1 = fopen($sourceSerialized, "r");
    $text1 = fread($file1, filesize($sourceSerializedValues));
    $dataValues = unserialize($text1);
    fclose($file1);

    $sourceSerializedLegends = '../temp/data-serialized-legends.txt';
    $file2 = fopen($sourceSerialized, "r");
    $text2 = fread($file2, filesize($sourceSerializedLegends));
    $dataLegends = unserialize($text2);
    fclose($file2);
...
//    /Diagramm($im, $VALUES, $LEGEND);
    Diagramm($im, $dataValues, $dataLegends);
